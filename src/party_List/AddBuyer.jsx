        ...
        <div className='w-75  ' style={{ height: "40rem" }}>
            <div className='w-auto mt-3  h-10 flex flex-row justify-between '>
                ...
                <div className='sub-div w-auto h-10 mb-4 ' style={{ borderLeft: "none", borderRight: "none", borderTop: "none" }}>
                    <button className='head-button w-28  text-white ms-3 h-10 ' style={{ border: "1px solid purple", borderTop: "none", borderRight: "none", borderLeft: "none" }}><FaBars /> Buyer  List</button>
                    ...
                    <button className='w-28  text-white ms-3 h-10 bg-purple-700 ' style={{ border: "1px solid purple", borderTop: "none", borderRight: "none", borderLeft: "none" }}>Add New Buyer</button>
