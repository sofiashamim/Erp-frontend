...
const CommercialList = () => {
    ...
    const apiEndpoint = 'http://localhost:2000/user/comm/getAllComm';
    ...
    const onEdit = async (id) => {
      try {
        let response = await fetch(`http://localhost:2000/user/comm/update/${id}`, {
          method: 'PUT',
    ...
    const onDelete = async (id) => {
      try {
        let response = await fetch(`http://localhost:2000/user/comm/delete/${id}`, {
          method: 'DELETE',
        });
        if (response.ok) {
